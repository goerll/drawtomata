...
export const ZoomControl: React.FC = () => {
  ...
  return (
    <div className="absolute bottom-4 left-4 bg-[#10100E] bg-opacity-60 backdrop-blur-xl rounded-lg border border-[#30302B] border-opacity-50 shadow-lg z-10 flex items-center gap-1">
      <button
